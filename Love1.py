...
--------------------------------------------------
 Author      : Hanif khan 
 GitHub      : https://github.com/DunkTricker
 YouTube     : Dunk Tricker
 Youtube    : https://youtube.com/channel/UCh3vA2rzMp49OEH5fAwnWyw
 Facebook    : https://www.facebook.com/profile.php?id=100042965112748
--------------------------------------------------
"""
def tik():
	titik = ['.   ','..  ','... ']
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mDunk\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mDunkTricker\033[1;95m•◈•══════••◈•"
		try:
	...
	print('           \033[1;91mDunkTricker start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mdunktricker\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By dunktricker--•◈•---»" #Dev:MOHAMMAD
